        ...
        const checkStatus = async () => {
            ...
            try {
                ...
                if (!sub) {
                    ...
                    if (endDate) {
                        // Grace period of 5 days after the end of the billing month
                        const expiryWithGrace = new Date(endDate);
                        expiryWithGrace.setDate(expiryWithGrace.getDate() + 5);
                        isExpiredDate = now > expiryWithGrace;
                    }
            ...
            {showExpiredModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Falta de Pago</h2>
                        <p className="text-gray-600 mb-6">
                            Tu periodo de gracia de 5 días ha vencido o hay un pago pendiente. Para continuar usando la plataforma, por favor regulariza tu situación.
                        </p>

                        <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 mb-6 text-left text-sm">
                            <p className="font-bold text-indigo-900 mb-2">Datos para Transferencia:</p>
                            <p className="text-indigo-800"><strong>Banco:</strong> Banco Familiar</p>
                            <p className="text-indigo-800"><strong>Cuenta:</strong> 45-639689</p>
                            <p className="text-indigo-800"><strong>Titular:</strong> Juan Carlos Piris Sanchez</p>
                            <p className="text-indigo-800"><strong>CI:</strong> 5.532.160</p>
                        </div>

                        <div className="space-y-3">
                            <a
                                href="https://wa.me/595981123456?text=Hola,%20adjunto%20mi%20comprobante%20de%20pago"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-full flex justify-center items-center gap-2 bg-[#25D366] text-white font-bold py-3 rounded-xl hover:bg-[#1ebd5b] transition"
                            >
