...
export const ManageVenues: React.FC<ManageVenuesProps> = ({ venues, onVenueDeleted }) => {
    ...
    const handleDelete = async (venueId: string) => {
        if (!window.confirm('¿Estás seguro de que quieres eliminar este complejo? Esta acción borrará también todas las canchas y reservas asociadas y NO se puede deshacer.')) {
            return;
        }
